...
<form action="/alumno" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="number" id="tlfn" name="tlfn" class="form-control" tabindex="4">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select name="carrera_id" id="carrera_id" class="form-control" tabindex="6" onchange="searchSecciones()">
    ...
    <div class="mb-3">
        ...
        <select name="seccion_id" id="seccion_id" class="form-control" tabindex="7">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="direccion" name="direccion" class="form-control" tabindex="8">
    </div>
    <a href="/alumno" class="btn btn-secondary" tabindex="9">Cancelar</a>
